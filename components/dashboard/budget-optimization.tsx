...
export default function BudgetOptimization({ currentMonth }: BudgetOptimizationProps) {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Marketing Budget Optimization ({currentMonth})</CardTitle>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Projected revenue improvement ({currentMonth})</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Key strategic suggestions ({currentMonth})</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Current vs Recommended allocation percentages ({currentMonth})</CardDescription>
        </CardHeader>
        <CardContent>
