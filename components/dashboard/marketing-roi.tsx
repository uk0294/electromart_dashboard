...
export default function MarketingROI({ currentMonth }: MarketingROIProps) {
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Marketing Channel ROI</CardTitle>
          <CardDescription>Return on investment by marketing channel ({currentMonth})</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Impact of marketing spend on revenue ({currentMonth})</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Delayed impact of marketing on revenue ({currentMonth})</CardDescription>
          </CardHeader>
          <CardContent className="h-[300px] flex items-center justify-center">
            <div className="text-center">
