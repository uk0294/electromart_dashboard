    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Revenue and growth by product category ({currentMonth})</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Best marketing channels for each product category ({currentMonth})</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Strategic product categories for {currentMonth}</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
